...
class Model_Finder:
    ...
    def get_best_params_for_random_forest(self,train_x,train_y):
        ...
        try:
            ...
            self.log_db_writer.log(self.log_database,self.log_collection,
                                   'Exception occured in get_best_params_for_random_forest method of the Model_Finder class. Exception message:  ' + str(
                                       e))
            self.log_db_writer.log(self.log_database,self.log_collection,'Random Forest Parameter tuning  failed. Exited the get_best_params_for_random_forest method of the Model_Finder class')
    ...
    def get_best_params_for_xgboost(self,train_x,train_y):
        ...
        self.log_db_writer.log(self.log_database,self.log_collection,'Entered the get_best_params_for_xgboost method of the Model_Finder class')
        ...
        try:
            ...
            self.log_db_writer.log(self.log_database,self.log_collection, 'XGBoost best params: ' + str(
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        self.log_db_writer.log(self.log_database,self.log_collection,'Entered the get_best_model method of the Model_Finder class')
        ...
        try:
            ...
            self.log_db_writer.log(self.log_database,self.log_collection,
                                   'Exception occured in get_best_model method of the Model_Finder class. Exception message:  ' + str(
                                       e))
            self.log_db_writer.log(self.log_database,self.log_collection,'Model Selection Failed. Exited the get_best_model method of the Model_Finder class')
